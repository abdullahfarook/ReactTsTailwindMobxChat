                ...
                <div className={cn(
                    ...
                    <div className="flex h-full flex-col">
                        <nav id="chat-history-nav" aria-label="Chat History" className="flex h-full flex-col px-2 pb-3.5 md:px-3">
                            ...
                            <button onClick={()=> auth.logout()} role="combobox" aria-expanded="false" aria-haspopup="listbox" aria-autocomplete="none" aria-label="Account Settings" data-testid="nav-user" className="mt-text-sm flex h-auto w-full items-center gap-2 rounded-xl p-2 text-sm transition-all duration-200 ease-in-out hover:bg-surface-hover"
                                ...
                                <div className="mt-2 grow overflow-hidden text-ellipsis whitespace-nowrap text-left text-text-primary" style={{ "marginTop": "0px", "marginLeft": "0px" }}>{session.fullName}</div>
                            </button>
