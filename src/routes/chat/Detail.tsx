      ...
      <div className="flex flex-col items-center gap-0 p-2">
         <div className="flex flex-col md:flex-row items-center justify-center gap-2">
            <div className="relative size-10 justify-center ">
               <div className="mt-1 relative flex h-full items-center justify-center rounded-full bg-white dark:bg-presentation dark:text-white text-black dark:after:shadow-none ">
                  <svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg" strokeWidth={1.5} className="h-2/3 w-2/3 text-black dark:text-white">
            ...
            <p className="py-1 split-parent inline overflow-hidden text-2xl sm:text-4xl font-medium text-text-primary" aria-hidden="true" style={{"textAlign":"center","whiteSpace":"normal","overflowWrap":"break-word"}}>Good day, {session.firstName}</p>
         </div>
      </div>
   </div>
