    ...
    return <>
        <div className="text-token-text-primary w-full border-0 bg-transparent dark:border-0 dark:bg-transparent">
            <div className="m-auto justify-center p-4 py-2 md:gap-6">
                <div id="c4339f98-5da5-454c-b221-4b2814fcfc3a"
                     aria-label="message-6-c4339f98-5da5-454c-b221-4b2814fcfc3a"
                    ...
                    <div className="relative flex flex-shrink-0 flex-col items-center">
                        <div className="flex h-6 w-6 items-center justify-center overflow-hidden rounded-full">
                            <div className="relative flex items-center justify-center"
                                ...
                                <div className="relative flex h-9 w-9 items-center justify-center rounded-sm p-1 text-white"
                                     style={{
                    ...
                    <div className="relative flex w-11/12 flex-col user-turn">
                        ...
                        <div className="flex flex-col gap-1">
                            <div className="flex max-w-full flex-grow flex-col gap-0">
                                <div className="text-message flex min-h-[20px] flex-col items-start gap-3 overflow-visible [.text-message+&amp;]:mt-5"
                                     dir="auto">
        ...
        <div className="text-token-text-primary w-full border-0 bg-transparent dark:border-0 dark:bg-transparent">
            <div className="m-auto justify-center p-4 py-2 md:gap-6">
                <div id="59f0b8f9-556e-462d-a2a1-848cfd5269b3"
                     aria-label="message-7-59f0b8f9-556e-462d-a2a1-848cfd5269b3"
                     className="group mx-auto flex flex-1 gap-3 transition-all duration-300 transform-gpu md:max-w-[47rem] xl:max-w-[55rem] focus:outline-none focus:ring-2 focus:ring-border-xheavy message-render">
                    <div className="relative flex flex-shrink-0 flex-col items-center">
                        <div className="flex h-6 w-6 items-center justify-center overflow-hidden rounded-full">
                            <div title="ChatGPT"
                                 className="relative flex h-9 w-9 items-center justify-center rounded-sm p-1 text-white"
                                 style={{"background": "rgb(171, 104, 255)", "width": "28.8px", "height": "28.8px"}}>
                                <OpenAIMinimalIcon/>
                            </div>
                        </div>
                    </div>
                    <div className="relative flex w-11/12 flex-col agent-turn">
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <span className="msg-content"></span></div>
                    </div>
                </div>
            </div>
        </div>
